...
export function App() {
  ...
  return (
    <div className='min-h-screen flex flex-col'>
      <div className='px-6 py-3 flex items-center justify-between border-b border-destructive'>
      ...
      <main className='flex-1 p-6 flex gap-6'>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p className='text-sm text-muted-foreground'>
            Lembre-se: você pode utilizar a variável <code className='text-secondary-foreground'>{`{transcription}`}</code> no seu
